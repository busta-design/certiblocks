...
**Important:** This application requires user authentication to function. All features are protected and accessible only to registered users.

**Quick Start:**

1. Visit [https://sueltitos.vercel.app/](https://sueltitos.vercel.app/)
2. Register at [/auth/registro](https://sueltitos.vercel.app/auth/registro)
3. Login with your credentials to access all features

**Example:** After authentication, you can view deposit management features like [this user profile](https://sueltitos.vercel.app/usuarios/961fdf6a-0d50-470a-a580-7b15108f7f08) showing deposits in bolivianos.

This is a potencial prototipe ready to be built soon.
...
4. **Depositar FIAT y convertir a tokens**:
   ...
   await platform.executeFiatToTokenConversion(
